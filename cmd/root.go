...
var rootCmd = &cobra.Command{
	...
	Long: `Todo is a simple and unobtrusive todo list manager. 
	
It let's you focus on the tasks you wish to complete by maintaining
a list of tasks you want to do, allowing you to add, remove, mark as completed
